...
class Spice:
    ...
    def compute_score(self, gts, res):
        ...
        # in_file is binary and json.dump writes to str files
        # hence the following workround:
        in_file.write(json.dumps(input_data, indent=2).encode(encoding='UTF-8'))
        in_file.close()
        ...
        try:
            ...
            print("Called process error: ", exc.output)
        """
